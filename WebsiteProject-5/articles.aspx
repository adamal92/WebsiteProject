		...
		<a href="">
			<div class="container" id="c1">
				...
				<div class="story" id="s1">
					...
					<p>The study of digital visual contents, involves the synthesis and manipulation 
						of image data. The study is connected to computer vision, image processing, and 
						computational geometry, and is 
						applied in special effects and video games.</p>
					</div>
				</div>
			</div>
		</a>
		...
		<a href="">
			<div class="container" id="c2">
				...
				<div class="story" id="s2">
					<div class="info">
					<h3>Hardware</h3>
					<p>Any physical component of a computer system that contains a circuit board, ICs, 
						or other electronics. A perfect example of hardware is the screen on which you 
						are viewing this page. Includes the physical, tangible parts or components of a computer.</p>
					</div>
				</div>
			</div>
		</a>
	...
	<a href="https://en.wikipedia.org/wiki/Assembly_language">
		<div class="container" id="c0">
			...
			<div class="story" id="s0">
				...
				<p>Any low-level programming language in which there is a very strong correspondence between the instructions in the language and the architecture's machine code instructions. Every assembler is designed for exactly one specific computer architecture</p>
				</div>
			</div>
		</div>
	</a>
